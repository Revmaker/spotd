...
export const findMaxSumOfContiguousSubArray = function optimalSolution(
  arrIntegers: Array<number>
...
const updateScoresBasedOnLinePosition = (
  scorePerLine: Array<number>
): Array<number> => {
  return scorePerLine;
};
